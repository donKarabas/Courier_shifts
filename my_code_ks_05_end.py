...
class Statistics:
    ...
    def calc_statistics(self):
        ...
        self.count_deliv = count_deliv
        self.count_hours_rub = count_hours_rub
        self.count_deliv_rub = self.count_deliv * self.rate_deliv
        self.count_deliv_rub = round(round(self.count_deliv_rub))
        self.count_month_revenue = count_month_revenue
        self.count_good_works_rub = count_good_works_rub
        self.total_incom = self.count_hours_rub + self.count_deliv_rub
